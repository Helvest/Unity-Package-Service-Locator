...
public class MonoServiceLocator : MonoBehaviour, IHoldSL
{
    ...
    [field: SerializeField] public UseCaseParent ForThisParent { get; private set; } = UseCaseParent.UseVarOrGlobal;

    [field: SerializeField] public MonoServiceLocator Parent { get; private set; }
    ...
    [Header("Prefabs")] [SerializeField] private Transform _transformParentForPrefabs;

    [SerializeField] private List<MonoBehaviour> _servicesPrefab = new List<MonoBehaviour>();
    ...
    [Header("Debug")] [SerializeField] private bool _useDebugLog;

    [SerializeField] private bool _autoSetActiveService;

    [SerializeField] private bool _serviceActiveValueToSet;
